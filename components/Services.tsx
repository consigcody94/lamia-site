    ...
    <section id="services" className="relative px-4 py-24 md:px-8 md:py-32">
      ...
      <div className="mx-auto max-w-6xl">
              ...
              <div className="flex items-start gap-5">
                <div
                  ...
                  style={{
                    ...
                    color: "#c8977a",
                    background: "radial-gradient(circle, rgba(114,31,53,0.3), transparent 70%)",
                    textShadow: "0 0 18px rgba(114,31,53,0.9)",
                  }}
                >
                  {s.glyph}
                </div>
                <div>
                  <h3 className="font-display text-xl font-semibold tracking-wide text-[#ebdcc4]">
                    {s.name}
                  </h3>
                  <p className="mt-1 font-caps text-[10px] uppercase tracking-[0.3em]" style={{ color: "#a8a09b" }}>
                    {s.format}
                  </p>
                </div>
              </div>
              <p className="mt-5 font-serif text-sm leading-relaxed text-[#ebdcc4]/75">
                {s.description}
              </p>
            </motion.div>
          ))}
        ...
        <div className="mt-14 text-center">
          <a
            href={LINKS.contact}
            className="inline-flex items-center gap-3 rounded-full border px-10 py-4 font-caps text-xs uppercase tracking-[0.4em] shadow-[0_0_50px_-10px_rgba(114,31,53,0.9)] transition"
            style={{
              borderColor: "rgba(200,151,122,0.8)",
              background:
                "linear-gradient(180deg, rgba(114,31,53,0.35), rgba(74,16,32,0.45))",
              color: "#ebdcc4",
            }}
          >
            ☾ Request Counsel
          </a>
          <p className="mt-4 font-serif text-[11px] italic text-[#ebdcc4]/45">
