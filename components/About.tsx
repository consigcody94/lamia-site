  ...
  return (
    <section id="about" className="relative px-4 py-24 md:px-8 md:py-32">
      ...
      <div className="mx-auto max-w-4xl">
        ...
        >
          <p className="font-display text-sm italic uppercase tracking-[0.3em]" style={{ color: "#c8977a" }}>
            {PRIEST.title} · {PRIEST.location}
          </p>
          <div className="mt-6 flex flex-col gap-5 font-serif text-base leading-relaxed text-[#ebdcc4]/80">
            <p>
            ...
            <p>
              ...
              dialogue with the <a href={LINKS.nol} target="_blank" rel="noopener" className="transition hover:text-[#a8a09b]" style={{ color: "#c8977a" }}>Novus Ordo Luciferi</a>, the{" "}
              <a href={LINKS.lrs} target="_blank" rel="noopener" className="transition hover:text-[#a8a09b]" style={{ color: "#c8977a" }}>Luciferian Research Society</a>, and the wider
          ...
          <div className="mt-8 border-t border-red-950/40 pt-6">
            <p className="font-caps text-[10px] uppercase tracking-[0.35em] text-[#ebdcc4]/50">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-x-5 gap-y-2 font-caps text-[10px] uppercase tracking-[0.3em]">
              <a href={LINKS.nol} target="_blank" rel="noopener" className="transition hover:text-[#a8a09b]" style={{ color: "#c8977a" }}>Novus Ordo Luciferi</a>
              <span className="text-[#ebdcc4]/20">·</span>
              <a href={LINKS.lrs} target="_blank" rel="noopener" className="transition hover:text-[#a8a09b]" style={{ color: "#c8977a" }}>Luciferian Research Society</a>
              <span className="text-[#ebdcc4]/20">·</span>
              <a href={LINKS.tools} target="_blank" rel="noopener" className="transition hover:text-[#a8a09b]" style={{ color: "#c8977a" }}>Ritual Tools</a>
              <span className="text-[#ebdcc4]/20">·</span>
              <a href={LINKS.discord} target="_blank" rel="noopener" className="transition hover:text-[#a8a09b]" style={{ color: "#c8977a" }}>Discord</a>
            </div>
          </div>
        </motion.div>
      </div>
